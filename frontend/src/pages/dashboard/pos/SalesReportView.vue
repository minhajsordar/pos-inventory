<template>
  <q-page padding>
    <div class="relative overflow-x-auto">
      <ReportQTable title="Sales Report" :columns="columns" :data-list="product_saleList?.productSales || []"
        :page="product_saleList?.page || 1" :pages="product_saleList?.pages || 1" @updatePaginate="updatePaginate"
    ...
    <q-dialog v-model="deletePopup">
      <q-card style="width: 300px; max-width: 80vw">
        ...
        <q-card-actions align="right" class="bg-white text-teal">
          ...
          <q-btn flat label="Delete" v-close-popup @click="deleteProductSale" color="red" />
        </q-card-actions>
      </q-card>
    </q-dialog>
  </q-page>
