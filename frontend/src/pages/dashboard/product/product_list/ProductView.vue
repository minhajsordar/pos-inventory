<template>
  <q-page padding>
    <div class="w-full flex justify-end pb-3">
      <template v-if="userAuthStore.checkShowOnPermission('createProduct')">
        <q-btn
          style="background: green; color: white"
          label="New Product"
          to="/dashboard/product/product_list/create"
        />
      </template>
    </div>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
      <CompactQTable
        :columns="columns"
        :data-list="productList?.products || []"
        :page="productList?.page || 1"
        :pages="productList?.pages || 1"
